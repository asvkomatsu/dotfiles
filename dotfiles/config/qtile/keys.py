...
keys = [
    ...
    Key(
        [MOD_KEY, 'control'], 'slash',
        lazy.spawn(LOCK_SCREEN_CMD, shell=True),
        desc='Take a screenshot'
    ),
    Key(
    ...
    Key(
        [], 'XF86AudioPlay',
        lazy.spawn(MEDIA_TOGGLE_PLAY),
        desc='Play audio'
    ),
    Key(
        [], 'XF86AudioStop',
        lazy.spawn(MEDIA_STOP),
        desc='Stop audio'
    ),
    Key(
        [], 'XF86AudioPrev',
        lazy.spawn(MEDIA_PREV),
        desc='Prev audio file'
    ),
    Key(
        [], 'XF86AudioNext',
        lazy.spawn(MEDIA_NEXT),
        desc='Next audio file'
    ),
]
